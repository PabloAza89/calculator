...
Calculator.prototype.number = function(number) {
    if (this._firstNumber === false && this._secondNumber === 0 && number === undefined && this._equal === 0) return 0
    if (this._firstNumber === false && this._secondNumber === 0 && number === 0 && this._equal === 0) return 0
    if (this._firstNumber === false && this._secondNumber === 0 && this._equal === 0) {
...
Calculator.prototype.plus = function() {
    if (!this._firstNumber && this._secondNumber === 0) return 0
    this._plus = true
...
Calculator.prototype.equal = function() {
    ...
    if (this._plus === true) {
        ...
        this._secondNumber = this._equal
        this.plus === false
        return this._equal;
    }
